...
function AppInExchange(){
  ...
  return(
    ...
    <AppBar position="static" style={{backgroundColor:"#A4C8EC", background:"rgba(164, 200, 236, 0.75)" }}>
      <Container fixed>
        <Toolbar>
          ...
          <Box mr={3}>
          <Button color="4c7bd9" variant='contained'>Биржа заявок</Button>
          </Box>
          <Box mr={3}>
    ...
    <main>
      ...
      <Container maxWidth="md" style={{position: "relative", top: "-230px", backgroundColor:"rgba(164, 200, 236, 0.75)", width:"880px"}}>
        <div>     
            <TextField id="filled-basic" label="Проблема" variant="filled" style={{width:"830px"}} />
        </div>
        <div>    
            <TextField id="filled-multiline-static" label="Описание проблемы" multiline rows={19} variant="filled" style={{width:"830px", marginTop:"10px"}}/>
        </div>     
        <div>
            <IconButton>
                <AttachFileIcon fontSize='large'/>
            </IconButton>
            <Button color="4c7bd9" variant='contained' style={{marginTop:"10px", marginBottom:"10px", position: "relative", left: "350px"}}>Переадресовать</Button>
            <Button color="4c7bd9" variant='contained' style={{marginTop:"10px", marginBottom:"10px", position: "relative", left: "350px"}}>Назначить</Button>
            <Button color="4c7bd9" variant='contained' style={{marginTop:"10px", marginBottom:"10px", position: "relative", left: "350px"}}>Взять</Button>
        </div>     
      </Container>
      </Paper>
    </main>
